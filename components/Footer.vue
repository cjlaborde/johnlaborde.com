...
import global from '@/utils/global';
  ...
  export default defineComponent({
      ...
      const facebookURL = ref(global.facebookURL);
      const instagramURL = ref(global.instagramURL);
      const twitterURL = ref(global.twitterURL);
      const githubURL = ref(global.githubURL);

      return { siteName, facebookURL, instagramURL, twitterURL, githubURL };
      }
  });
</script>
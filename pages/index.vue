              ...
              <div class="pl-5 lg:pl-15">
                <div class="space-y-4">
                  ...
                  <div class="flex space-x-5">
                    <div>
                      <a :href="twitterInURL" class="text-gray-400 hover:text-gray-500">
...
import global from '@/utils/global';
  ...
  export default defineComponent({
      setup() {
        ...
        const twitterInURL = ref(global.twitterURL);
        const linkedInURL = ref(global.linkedInURL);

        return { author, about, avatar, twitterInURL, linkedInURL };
      }
  });
</script>
